...
public class ShowRoute extends FragmentActivity implements OnMapReadyCallback,
        ...
        public void onMapReady(GoogleMap googleMap) {
            ...
            MarkerPoints.add(first);
            MarkerPoints.add(last);
            MarkerPoints.add(new LatLng(30.25,78.25));
            MarkerPoints.add(new LatLng(30.50,78.25));
            MarkerPoints.add(new LatLng(30.75,78.25));
            MarkerPoints.add(new LatLng(30.75,78.50));
            MarkerPoints.add(new LatLng(30.9947,78.50));
